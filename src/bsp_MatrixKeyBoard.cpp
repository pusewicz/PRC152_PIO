...
void bsp_Matrix_DeInit(void)
{
    pinMode(KEY_ROW1_PIN, INPUT_PULLDOWN);
    pinMode(KEY_ROW2_PIN, INPUT_PULLDOWN);
    pinMode(KEY_ROW3_PIN, INPUT_PULLDOWN); 
    pinMode(KEY_ROW4_PIN, INPUT_PULLDOWN);
