...
#define KDU_DATA_DEBUG 1    // Data interaction processing (using strings, stable data transfer, not easily escaped by characters)
#if KDU_DATA_DEBUG
...
//get the maximun and minimum values in the range   [a,b]
#define RANGE_X(a, b, x)    ( ((x) < (a)) ? (a) : ( ((x) > (b)) ? (b) : (x) ) )
/////////////////////////////////////////////////////////////////////////////////////////
...
// Returns a value that is the nearest multiple of n greater than x
