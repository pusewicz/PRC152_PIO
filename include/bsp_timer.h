...
#define DAC_SAMPLE_2K           (int)(1000000 / (TIMER_INTR_US * 2000) + 0.5)       // DAC 2K sample data
#define DAC_SAMPLE_1_5K         (int)(1000000 / (TIMER_INTR_US * 1500) + 0.5)       // DAC 1.5K sample data
