...
void LCD_HeavyRatio(unsigned char cmd);                                                                             // Coarse contrast adjustment    // 0x20-0x27 internal resistor ratio
void LCD_LightRatio(unsigned char cmd);                                                                             // Fine contrast adjustment    // 0-0x3f internal resistor fine tuning

void LCD_Setxy(unsigned char l, unsigned char p);                                                                   // Position function
...
void LCD_ShowPIC0408(unsigned char l, unsigned char p, unsigned char  ch);                                          // Up/down arrows, volume small block
...
void LCD_ShowPIC2516(unsigned char l, unsigned char p, int ch);                                                     // Display keys 0-9
