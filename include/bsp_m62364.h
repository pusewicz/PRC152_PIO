...
#define FM_S_EN_CHAN                2       // FM radio power enable channel
#define MIC_OUT_CHAN                3       // External MIC enable & gain control
#define MIC_IN_CHAN                 4       // Internal/top MIC enable & gain control

#define WFM_LINE_CHAN               5       // FM radio channel
#define A20_LINE_CHAN               6       // RF module receive audio
